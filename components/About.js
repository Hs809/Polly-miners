      ...
      >
        <div className="about-header">
          <div className="about-mission">
            <p
              onClick={() => handleData("values")}
              className={state == "values" ? "active" : ""}
            >
              Values
            </p>
            <p
              onClick={() => handleData("mission")}
              className={state == "mission" ? "active" : ""}
            >
              Mission
            </p>
            <p
              onClick={() => handleData("vision")}
              className={state == "vision" ? "active" : ""}
            >
              Vision
            </p>
          </div>
      ...
      <div className="about-description">
        <div id="values">
          ...
          <div className="description-details">
            ...
            >
              <h3 className="description-details-title">{data.mainTitle}</h3>
            </Animate>
            <Animate
              play={animate}
              duration={0.9}
